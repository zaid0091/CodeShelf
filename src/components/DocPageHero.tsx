...
export function DocPageHero({ page, chapterIndex, chapterCount }: DocPageHeroProps) {
  ...
  return (
    <ScrollReveal animation="fade-up" duration={0.85} distance={28}>
      <header className="doc-hero">
        ...
        <div className="doc-hero__rail" aria-hidden />

        <div className="doc-hero__inner">
          <div className="doc-hero__topline">
            <Link
              to={overviewPath}
          ...
          <h1 className="doc-hero__title font-display">{page.title}</h1>

          {page.description && (
            <p className="doc-hero__desc">{page.description}</p>
          )}
